...
[_QWERTY] = LAYOUT(
  ...
  KC_ESC,   KC_A,   KC_S, SFT_T(KC_D), CTL_T(KC_F), KC_G,                     KC_H,       CTL_T(KC_J),  SFT_T(KC_K), KC_L,  KC_SCLN, KC_QUOT,
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,              KC_RBRC,  KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RCTL,
                       KC_LGUI, KC_LALT, MO(_L1), KC_SPC,                    KC_ENT, MO(_L2), KC_RALT, KC_RGUI
),
