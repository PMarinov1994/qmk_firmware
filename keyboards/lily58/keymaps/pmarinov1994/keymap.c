...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,              KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RCTL,
                       KC_LALT, KC_LGUI, MO(_L1), KC_SPC,                    KC_ENT,   TT(_L1), KC_BSPC, KC_BSPC
),
...
[_L1] = LAYOUT(
  ...
  _______,       KC_QUES, _______, _______, _______, _______, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
                             _______, _______, KC_LAYER_DOWN, _______, _______, KC_LAYER_UP, _______, _______
),
...
[_L2] = LAYOUT(
  ...
  _______, RCS(KC_C),  RCS(KC_V),  KC_PGDN, KC_PGUP, XXXXXXX,   _______, _______,                  KC_PLUS, KC_MINS,        KC_EQL,       KC_LBRC, KC_RBRC,  KC_BSLS,
